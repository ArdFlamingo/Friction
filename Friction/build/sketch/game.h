#line 1 "/Users/om/Downloads/ARDUBOY/Friction/game.h"
#pragma once
...
public:
	...
	{
		if(this->currentMapIndex > firstMapIndex)
			--this->currentMapIndex;
	}

	// Same as selectPreviousMap, but reports success
	bool trySelectPreviousMap()
	{
		if(this->currentMapIndex == firstMapIndex)
			return false;
